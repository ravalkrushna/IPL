...
const styles = `
  ...
  .auth-label { font-size: 12px; font-weight: 700; color: var(--ink-muted); }
      ...
      <div className="auth-body">
        <div className="auth-card">
          ...
          <div className="auth-card-top">
            ...
            <h1 className="auth-card-title">Join the Auction</h1>
            <p className="auth-card-sub">Create your account and start bidding</p>
          </div>
